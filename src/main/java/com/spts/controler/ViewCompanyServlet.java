		...
		for (Company c : list) {
			...
			// ADMIN VIEW
				...
				out.println(
						...
						"<a href='DeleteCompanyServlet?cid=" + c.getCid() + "' class='btn-delete'>"

								+ "<i class='bi bi-trash-fill'></i> " + "Delete"

								+ "</a>");

				out.println("<a href='UpdateCompanyServlet?cid=" + c.getCid() + "' class='btn btn-primary ms-2'>"
